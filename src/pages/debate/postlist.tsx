...
const PostListDebatePage = () => {
  ...
  const mbtiBoardList = [
  {
    ...
    content: "조별과제할 때",
    selectedOptions: [
      {textContent:"어쩌구 저쩌구 하는 ENTP",imageContentURL:"https://i.ibb.co/w04Prt6/c1f64245afb2.gif"},
      {textContent:"어쩌구 저쩌구 하는 ENTP",imageContentURL:"https://i.ibb.co/w04Prt6/c1f64245afb2.gif"},
      {textContent:"어쩌구 저쩌구 하는 ENTP",imageContentURL:"https://i.ibb.co/w04Prt6/c1f64245afb2.gif"},
      {textContent:"어쩌구 저쩌구 하는 ENTP",imageContentURL:"https://i.ibb.co/w04Prt6/c1f64245afb2.gif"},
  ],
...
},
{
  ...
  selectedOptions: [
    {textContent:"어쩌구 저쩌구 하는 ENTP",imageContentURL:"https://i.ibb.co/w04Prt6/c1f64245afb2.gif"},
    {textContent:"어쩌구 저쩌구 하는 ENTP",imageContentURL:"https://i.ibb.co/w04Prt6/c1f64245afb2.gif"},
    {textContent:"어쩌구 저쩌구 하는 ENTP",imageContentURL:"https://cdn.eyesmag.com/content/uploads/posts/2022/08/08/main-ad65ae47-5a50-456d-a41f-528b63071b7b.jpg"},
  ],
  voteratio:[62.5,37.5,0],
  createdAt: "23.06.14",
  chose:false,
  participants: 32,
  comment: 10,
