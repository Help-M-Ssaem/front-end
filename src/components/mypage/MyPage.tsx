...
import { UseEvaluation } from "../../hooks/mypage/useEvaluation";
      ...
      <div css={spaceBetween}>
        ...
        <div>
          ...
          <div css={contentContainer}>
            <div css={contentBox}>
              <p>좋아요</p>
              <p css={contentNumber}>{evaluation.likeCount}</p>
            </div>
            <div css={contentBox}>
              <p>유익해요</p>
              <p css={contentNumber}>{evaluation.usefulCount}</p>
            </div>
            <div css={contentBox}>
              <p>재밌어요</p>
              <p css={contentNumber}>{evaluation.funCount}</p>
            </div>
            <div css={contentBox}>
              <p>성의있어요</p>
              <p css={contentNumber}>{evaluation.sincereCount}</p>
            </div>
            <div css={contentBox}>
              <p>화끈해요</p>
              <p css={contentNumber}>{evaluation.hotCount}</p>
            </div>
          </div>
        </div>
        {/* 게시판 활동 */}
